...
if ret:
    processed = process_frame(frame, camera_id="live_cam", user_email="anooparavindassery@gmail.com")
...
def gen_frames():
    while True:
        ...
        if not success:
            break
        frame = process_frame(frame, camera_id="live_cam", user_email="anooparavindassery@gmail.com")
